...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        //    {
        //        var asOk = entitiesResult.AsOk();

        //        var entitiesCheckpoints = asOk.Filter(e => e.gid == "checkpoint");
        //        if (entitiesCheckpoints != null)
        //        {
        //            Checkpoint preferredCheckpoint = null;

        //            foreach (var entity in entitiesCheckpoints)
        //            {
        //                if (Checkpoint.Checkpoints.TryGetValue(entity.eid, out var checkpoint))
        //                {
        //                    if (preferredCheckpoint != null)
        //                    {
        //                        if (preferredCheckpoint.CheckpointIndex < checkpoint.CheckpointIndex) preferredCheckpoint = checkpoint;
        //                    }
        //                    else preferredCheckpoint = checkpoint;
        //                }
        //            }

        //            if (preferredCheckpoint != null)
        //            {
        //                Debug.Log("Try spawn in " + preferredCheckpoint.CheckpointId);
        //                SetCheckpoint(preferredCheckpoint);
        //                Respawn();
        //            }
        //            else
        //            {
        //                Debug.Log("Try spawn in checkpoint that is null" );
        ...
        protected IEnumerator RespawnRoutine()
        {
            ...
            {
                Debug.Log("Try to Respawn " + m_CurrentCheckpoint.name);
